    ...
    for (var i = 0; i < this.tupleCount; i++) {
      ...
      switch (this.schemaType) {
        ...
        case CAS.CUBRIDSchemaType.CCI_SCH_ATTRIBUTE:
          ...
          SchemaInfo[i] = { Name : name, Domain : domain, Scale : scale, Precision : precision,
            Indexed              : index, NonNull : non_null, Shared : shared, Unique : unique, Default : def,
            AttrOrder            : attr_order, ClassName : class_name, SourceClass : source_class, IsKey : is_key
          };
          break;
      }
    }
